...
export const identifyPlatform = function (bannerConfig: SmartBannerOptions, osName: string): SmartAppBannerPlatform | null {
...
export const isMobileSafariPlatform = function (computedTheme: string, bowser: Parser.Parser) {
